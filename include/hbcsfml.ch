...
/* Graphics/Color */
#define sfBlack       {   0,   0,   0, 255 } ///< Black predefined color
#define sfWhite       { 255, 255, 255, 255 } ///< White predefined color
#define sfRed         { 255,   0,   0, 255 } ///< Red predefined color
#define sfGreen       {   0, 255,   0, 255 } ///< Green predefined color
#define sfBlue        {   0,   0, 255, 255 } ///< Blue predefined color
#define sfYellow      { 255, 255,   0, 255 } ///< Yellow predefined color
#define sfMagenta     { 255,   0, 255, 255 } ///< Magenta predefined color
#define sfCyan        {   0, 255, 255, 255 } ///< Cyan predefined color
#define sfTransparent {   0,   0,   0,   0 } ///< Transparent (black) predefined color
